...
int main (int argc, char *argv[]) {
	...
	string filename_error = "errors/ct_real/SRKWOR_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
	string filename_res = "errors/ct_real/SRKWOR_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
