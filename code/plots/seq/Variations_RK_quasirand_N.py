...
plt.scatter(x_50, RK_quasirand_halton_time_50, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_50, RK_quasirand_halton_time_50, linewidth=1.5, color='orange')
plt.scatter(x_50, RK_quasirand_sobol_time_50, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_50, RK_quasirand_halton_it_50, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_50, RK_quasirand_halton_it_50, linewidth=1.5, color='orange')
plt.scatter(x_50, RK_quasirand_sobol_it_50, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_100, RK_quasirand_halton_time_100, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_100, RK_quasirand_halton_time_100, linewidth=1.5, color='orange')
plt.scatter(x_100, RK_quasirand_sobol_time_100, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_100, RK_quasirand_halton_it_100, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_100, RK_quasirand_halton_it_100, linewidth=1.5, color='orange')
plt.scatter(x_100, RK_quasirand_sobol_it_100, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_200, RK_quasirand_halton_time_200, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_200, RK_quasirand_halton_time_200, linewidth=1.5, color='orange')
plt.scatter(x_200, RK_quasirand_sobol_time_200, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_200, RK_quasirand_halton_it_200, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_200, RK_quasirand_halton_it_200, linewidth=1.5, color='orange')
plt.scatter(x_200, RK_quasirand_sobol_it_200, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_500, RK_quasirand_halton_time_500, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_500, RK_quasirand_halton_time_500, linewidth=1.5, color='orange')
plt.scatter(x_500, RK_quasirand_sobol_time_500, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_500, RK_quasirand_halton_it_500, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_500, RK_quasirand_halton_it_500, linewidth=1.5, color='orange')
plt.scatter(x_500, RK_quasirand_sobol_it_500, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_750, RK_quasirand_halton_time_750, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_750, RK_quasirand_halton_time_750, linewidth=1.5, color='orange')
plt.scatter(x_750, RK_quasirand_sobol_time_750, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_750, RK_quasirand_halton_it_750, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_750, RK_quasirand_halton_it_750, linewidth=1.5, color='orange')
plt.scatter(x_750, RK_quasirand_sobol_it_750, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_1000, RK_quasirand_halton_time_1000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_1000, RK_quasirand_halton_time_1000, linewidth=1.5, color='orange')
plt.scatter(x_1000, RK_quasirand_sobol_time_1000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_1000, RK_quasirand_halton_it_1000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_1000, RK_quasirand_halton_it_1000, linewidth=1.5, color='orange')
plt.scatter(x_1000, RK_quasirand_sobol_it_1000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_2000, RK_quasirand_halton_time_2000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_2000, RK_quasirand_halton_time_2000, linewidth=1.5, color='orange')
plt.scatter(x_2000, RK_quasirand_sobol_time_2000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_2000, RK_quasirand_halton_it_2000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_2000, RK_quasirand_halton_it_2000, linewidth=1.5, color='orange')
plt.scatter(x_2000, RK_quasirand_sobol_it_2000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_4000, RK_quasirand_halton_time_4000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_4000, RK_quasirand_halton_time_4000, linewidth=1.5, color='orange')
plt.scatter(x_4000, RK_quasirand_sobol_time_4000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_4000, RK_quasirand_halton_it_4000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_4000, RK_quasirand_halton_it_4000, linewidth=1.5, color='orange')
plt.scatter(x_4000, RK_quasirand_sobol_it_4000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_10000, RK_quasirand_halton_time_10000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_10000, RK_quasirand_halton_time_10000, linewidth=1.5, color='orange')
plt.scatter(x_10000, RK_quasirand_sobol_time_10000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_10000, RK_quasirand_halton_it_10000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_10000, RK_quasirand_halton_it_10000, linewidth=1.5, color='orange')
plt.scatter(x_10000, RK_quasirand_sobol_it_10000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_20000, RK_quasirand_halton_time_20000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_20000, RK_quasirand_halton_time_20000, linewidth=1.5, color='orange')
plt.scatter(x_20000, RK_quasirand_sobol_time_20000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
...
plt.scatter(x_20000, RK_quasirand_halton_it_20000, linewidth=1.5, color='orange', label=r'SRK - Halton', marker='o', s=75)
plt.plot(x_20000, RK_quasirand_halton_it_20000, linewidth=1.5, color='orange')
plt.scatter(x_20000, RK_quasirand_sobol_it_20000, linewidth=1.5, color='blue', label=r'SRK - Sobol', marker='s', s=75)
