...
# python3 plots/paper/example_rand_coherent.py
...
l1 = Line.from_points([0,0], [12,12])
l4 = Line.from_points([4,0], [8,12])
l8 = Line.from_points([6,0], [6,12])
l2 = Line.from_points([8,0], [4,12])
l3 = Line.from_points([0,12], [12,0])
l6 = Line.from_points([0,8], [12,4])
l7 = Line.from_points([0,6], [12,6])
l5 = Line.from_points([0,4], [12,8])
...
filename_fig = "example_rand_coherent"
